...
const testimonials = [
  {
    ...
    location: "US",
    initials: "MM",
    letterUrl: "https://drive.google.com/file/d/1Q8aNJeKFp1G4LFW0X0-rssdwMYtLEeaF/view?usp=sharing",
  },
  {
    quote:
...
export default function Testimonials() {
  return (
    <section id="testimonials" className="py-20 px-4 sm:px-6 bg-[#F9FAFB] dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-5xl mx-auto">
        <AnimateIn>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-50 mb-3">What Clients Say</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {testimonials.map((t, i) => (
            <AnimateIn key={t.name} delay={i * 100} className="flex flex-col">
              <div
                className="bg-white dark:bg-gray-800 rounded-xl p-7 flex flex-col gap-5 flex-1"
                style={{ border: "1px solid var(--card-border)", borderTop: "2px solid #2563EB" }}
              >
                <svg className="w-8 h-8 text-blue-100 dark:text-blue-900" fill="currentColor" viewBox="0 0 32 32">
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed flex-1 italic">
                  &ldquo;{t.quote}&rdquo;
                </p>

                <div className="border-t border-gray-100 dark:border-gray-700 pt-5 flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-blue-50 dark:bg-blue-950/50 border border-blue-100 dark:border-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-400 font-semibold text-sm shrink-0">
                      {t.initials}
                    </div>
                    <div>
                  ...
                  {t.letterUrl && (
                    <a
                      ...
                      className="shrink-0 text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium transition-colors"
                    >
                      View letter
                    </a>
                  )}
